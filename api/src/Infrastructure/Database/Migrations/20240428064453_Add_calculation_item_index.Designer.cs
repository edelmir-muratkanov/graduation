...
namespace Infrastructure.Database.Migrations
{
    ...
    [Migration("20240428064453_Add_calculation_item_index")]
    partial class Add_calculation_item_index
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Calculation.Calculation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ProjectId")
                        .HasDatabaseName("ix_calculations_project_id");

                    b.HasIndex("MethodId", "ProjectId")
                        .HasDatabaseName("ix_calculations_method_id_project_id");

                    b.ToTable("calculations", (string)null);
                });

            modelBuilder.Entity("Domain.Calculation.CalculationItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<double>("Belonging")
                        .HasColumnType("double precision")
                        .HasColumnName("belonging");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_calculation_items");

                    b.HasIndex("CalculationId", "PropertyName")
                        .IsUnique()
                        .HasDatabaseName("ix_calculation_items_calculation_id_property_name");
            ...
            modelBuilder.Entity("Domain.Calculation.Calculation", b =>
                {
                    b.HasOne("Domain.Methods.Method", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_calculations_methods_method_id");
                    ...
                    b.HasOne("Domain.Projects.Project", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_calculations_projects_project_id");
                });

            modelBuilder.Entity("Domain.Calculation.CalculationItem", b =>
                {
                    b.HasOne("Domain.Calculation.Calculation", null)
                        .WithMany("Items")
                        .HasForeignKey("CalculationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_calculation_items_calculations_calculation_id");
                });
